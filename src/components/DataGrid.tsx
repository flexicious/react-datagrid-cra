...
import { Behaviors, ColumnOptions, ExcelBehavior, ExcelBehaviorOptions, GridOptions, PdfBehavior, PdfBehaviorOptions, createColumn, createEditBehavior, createFilterBehavior, itemToLabel, resolveExpression } from "@ezgrid/grid-core";
import { ReactDataGrid, ReactDataGridOptions, createMultiSelectFilterOptions, createSelectEditorOptions, getEditOptions, getFilterOptions } from "@ezgrid/grid-react";
...
export const DataGrid = (props: ReactDataGridOptions) => {
